...
This version has breaking changes — APIs, conventions, and file structure may all differ from your training data. Read the relevant guide in `node_modules/next/dist/docs/` and `README.md` before writing any code. Heed deprecation notices.
