...
- Navigation, headline stats, and key action panels include inline iconography for faster scanning.
...
- Duplicate detection flags receipts with the same merchant, date, and total.
